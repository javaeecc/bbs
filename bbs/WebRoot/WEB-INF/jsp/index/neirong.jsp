...
function gotologin(){
	window.location.href="${path}/login/index.do?pathlocation=${path}/post/${map.tiezi.id}_1_1.html";
}
 ...
 <%@ include file="/WEB-INF/inc/top.jsp"%>
   ...
   <div id="pt" class="bm cl"> 
    <div class="z"> 
     ...
     <em>›</em> 
     <a href="${path}/post/${map.tiezi.id}_1_1.html">${map.tiezi.name}</a> 
    </div> 
    <div class="y"> 
        ...
        <tr> 
         ...
         <td id="plc_240" class="plc"> 
          <div class="mtm pbm bbda"> 
           <h1 class="ts"> <a href="${path}/post/${map.tiezi.id}_1_1.html">[${map.tiezi.zhutiname}]</a> 
           <a href="${path}/post/${map.tiezi.id}_1_1.html" id="thread_subject">${map.tiezi.name}</a> </h1> 
           <span class="xg1"> </span> 
          </div> 
          <div class="pi"> 
...
<!-- 					<div>
               ...
               <td class="plc plm">
					...
					<c:forEach items="${listtiezi}" var="tiezi">
						<li>• <a href="${path}/post/${tiezi.id}_1_1.html" title="${tiezi.name }" target="_blank">${tiezi.name }</a></li>
					</c:forEach>
					</ul>
					</div>
				</td>
        ...
        <em>上一篇：<a href="${path}/post/${last.id}_1_1.html" style="color:#3399CC">${last.name}</a></em>
        </c:if>
        <c:if test="${not empty next}">
        <em>下一篇：<a href="${path}/post/${next.id}_1_1.html" style="color:#3399CC">${next.name}</a></em>
        </c:if>
        </div>
        </td>
        </tr>
        ...
        <tr class="ad"> 
         ...
         <td class="plc"> 
          <ul class="ttp cl"> 
           ...
           <li <c:if test="${orderby!='0'}">class="xw1 a"</c:if> ><a href="${path}/post/${map.tiezi.id}_1_1.html">正序浏览</a></li> 
           <li <c:if test="${orderby=='0'}">class="xw1 a"</c:if> ><a href="${path}/post/${map.tiezi.id}_1_0.html">倒序浏览</a></li> 
          </ul> </td> 
        </tr> 
        </c:if>
       </tbody>
    ...
    <c:if test="${!empty huifumap.list}">
     <div class="bm bw0 pgs cl"> 
        ...
        <a href="${path}/post/${map.tiezi.id}_${huifumap.pagestart-1}_${orderby}.html" class="prev"></a>
        </c:if>
         <strong>${huifumap.pagestart}</strong>
         <c:if test="${huifumap.pagestart!=huifumap.totalPages}">
         <a href="${path}/post/${map.tiezi.id}_${huifumap.pagestart+1}_${orderby}.html" class="nxt"></a>
         </c:if>
        </div>
