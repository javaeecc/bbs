  ...
  <div id="wp" class="wp"> 
   <div class="qing_space_tb cl"> 
    <ul class="tb cl"> 
     ...
     <li><a href="${path}/member/${user.id}_2.html">主题</a></li> 
          ...
          <tr> 
           ...
           <td> 
            <ul> 
             ...
             <li><em class="xg1">用户组&nbsp;&nbsp;</em><span style="color:#00CC00"><a href="javascript:;" ><font color="#00CC00">${ziliao.usergroupname}</font></a></span> </li> 
            </ul> 
            <ul id="pbbs" class="pf_l"> 
             <li><em>在线时间</em>${ziliao.onlinetime}小时</li> 
             <li><em>注册时间</em>${user.createtime}</li> 
             <li><em>最后登录</em>${user.lastlogintime}</li> 
            </ul> </td> 
          </tr> 
         </tbody>
        </table> 
