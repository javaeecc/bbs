...
<%@ include file="/WEB-INF/inc/taglibs.jsp"%>
 <div id="uhd"> 
   ...
   <div class="icn" style="margin-top:25px;"> 
    <a href="${path}/member/${user.id}_1.html"><img src="<%=request.getContextPath()%>/file/${user.img}" alt="${user.loginname}"/></a> 
   </div> 
   ...
   <!-- <p class="q_hdmenu mt cl"> 
     ...
     <a href="javascript:;" title="发送消息" class="oldbtn">发送消息</a> 
   </p>  -->
  </div> 
