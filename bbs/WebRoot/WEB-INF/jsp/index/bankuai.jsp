	           ...
	           <tr> 
	            ...
	            <th class="common"> 
	             <div class="q_f_title1"> 
	              ...
	              <a href="${path}/post/${zhiding.id}_1_1.html"  class="s xst">${zhiding.name}</a> 
          ...
          <c:forEach items="${page.list}" var="tiezi">
           <tr> 
            ...
            <th class="common"> 
             <div class="q_f_title1"> 
              <div class="z qing_fenlei">
               <em>[<a href="${path}/post/${tiezi.id}_1_1.html">${tiezi.zhutiname}</a>]</em> 
              </div> 
              <a href="${path}/post/${tiezi.id}_1_1.html"  class="s xst">${tiezi.name}</a> 
